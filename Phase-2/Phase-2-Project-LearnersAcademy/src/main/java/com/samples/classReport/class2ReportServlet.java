...
@WebServlet("/class2ReportServlet")
public class class2ReportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (Statement statement = connection.createStatement();) {
			...
			ResultSet results = statement.executeQuery("SELECT b.classID, b.className, d.subjectID, "
					...
					+ "WHERE b.classID='C02' ORDER BY b.classID;");
			PrintWriter out = response.getWriter();
			
			out.println("<h1>Class 2 Report:</h1>");
