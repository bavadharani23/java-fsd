...
@WebServlet("/class3ReportServlet")
public class class3ReportServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try (Statement statement = connection.createStatement();) {
			...
			ResultSet results = statement.executeQuery("SELECT b.classID, b.className, d.subjectID,"
					...
					+ " WHERE b.classID='C03' ORDER BY b.classID;");
			PrintWriter out = response.getWriter();
			
			out.println("<h1>Class 3 Report:</h1>");
